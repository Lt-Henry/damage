...
namespace damage
{
	...
	{		
		namespace v4f
		{
			...
			{
				/*
				r[0]= (m[4*0+0] * v[0]) + (m[4*0+1] * v[1])+(m[4*0+2] * v[2])+(m[4*0+3] * v[3]);
				r[1]= (m[4*1+0] * v[0]) + (m[4*1+1] * v[1])+(m[4*1+2] * v[2])+(m[4*1+3] * v[3]);
				r[2]= (m[4*2+0] * v[0]) + (m[4*2+1] * v[1])+(m[4*2+2] * v[2])+(m[4*2+3] * v[3]);
				r[3]= (m[4*3+0] * v[0]) + (m[4*3+1] * v[1])+(m[4*3+2] * v[2])+(m[4*3+3] * v[3]);
				*/
				r[0]= (m[4*0+0] * v[0]) + (m[4*1+0] * v[1])+(m[4*2+0] * v[2])+(m[4*3+0] * v[3]);
				r[1]= (m[4*0+1] * v[0]) + (m[4*1+1] * v[1])+(m[4*2+1] * v[2])+(m[4*3+1] * v[3]);
				r[2]= (m[4*0+2] * v[0]) + (m[4*1+2] * v[1])+(m[4*2+2] * v[2])+(m[4*3+2] * v[3]);
				r[3]= (m[4*0+3] * v[0]) + (m[4*1+3] * v[1])+(m[4*2+3] * v[2])+(m[4*3+3] * v[3]);
			}
		}
